...
#when testing file 
CHROMA_PATH = "/Users/macmini/Desktop/english_exam_generator/db_store/db_language_ex2"
...
def main():
    ...
    #if u want to generate language change first arg ="Language"
    text = generate_response("Language",query_text, templates.LANGUAGE_EX2_PROMPT_TEMPLATE, CHROMA_PATH, topics)
    print(text)
